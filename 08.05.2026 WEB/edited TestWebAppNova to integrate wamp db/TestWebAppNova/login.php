...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($inputEmail === '' || $password === '') {
        ...
        $stmt = $conn->prepare('SELECT password FROM customer WHERE username = ? LIMIT 1');
            ...
            <form action="login.php" method="POST" autocomplete="on">
                <div class="mb-3">
                    <div class="input-group">
                        ...
                        <input id="email" type="email" name="email" class="form-control" placeholder="Email Address" required autocomplete="username" value="<?php echo htmlspecialchars($inputEmail); ?>">
                    </div>
                </div>
                ...
                <a href="register.php" class="btn btn-secondary btn-login mt-3">Register</a>
